...
header .opt a {text-decoration: none;font-family:cursive;text-align: center;font-size:20px;color:#ff9966;margin-right: 15px}
...
.export {margin: 0px 0px 10px 20px; background-color:#900C3F ;font-family:cursive;border-radius: 7px;width: 145px;height: 28px;color: #ffffcc; border-color: #ffffcc;font-size:17px}
...
<h2 style="margin-left: 15px; color:#ffb366;">
